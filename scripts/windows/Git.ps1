...
# Función que verifica si Git está instalado en el sistema
function Comprobar_git {
    ...
    if (Test-Path $rutaGit) {
        ...
        switch ($Accion) {
            "actualizar" {
                choco upgrade git -y
                Write-Host "Git se ha actualizado correctamente."
                break
            }
            "desinstalar" {
                choco uninstall git -y
                Write-Host "Git se ha desinstalado correctamente."
                break
            }
            "cancelar" {
        ...
        Write-Host "Git no esta instalado en el sistema."
